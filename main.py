...
# Buttons
unknown_button = Button(image=red_x_image, command=generate_foreign_word, bg=BACKGROUND_COLOR, activebackground=BACKGROUND_COLOR, highlightthickness=0, bd=0,)
known_button = Button(image=green_check_image, bg=BACKGROUND_COLOR, activebackground=BACKGROUND_COLOR, highlightthickness=0, bd=0)
